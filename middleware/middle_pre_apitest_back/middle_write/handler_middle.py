...
if __name__ == "__main__":
    print(Handler().access_token('lrp'))
    print(Handler().headers('lrp'))
    print(register_member('lrp', headers=Handler().headers('lrp'), chanel_code='976'))
    pass
    # from middleware.middle_prd.middle_write import handler_middle
    # token = handler_middle.Handler().headers('lrp')
