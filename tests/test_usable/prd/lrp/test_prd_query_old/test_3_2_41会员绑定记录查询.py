...
cases = excel.read_data("query_member_bind_log")


@pytest.mark.lrp
@ddt.ddt
class TestQueryMemberBindLog(unittest.TestCase):
    ...
    @allure.step("会员绑定记录查询")
    @pytest.mark.query
    @pytest.mark.query_member_bind_log
    @ddt.data(*cases)
    def test_query_member_bind_log(self, data_info):
