...
# --------------------------------------------------------------------------------------------------------------------
        ...
        :param class_mobile: 提取会员mobile..
               ...
               """
        # 调用会员注册接口
        cls.class_register = handler_middle.register_member(
            cls.brand, headers=cls.headers, var=handler.yml_conf["var"]["vb_all_api"])
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        cls.class_tb_register = handler_middle.register_member(
            cls.brand, headers=cls.headers, chanel_code="976", var=handler.yml_conf["var"]["vb_all_api"])
...
# --------------------------------------------------------------------------------------------------------------------
    ...
    def setUp(self) -> None:
        ...
        # 调用会员注册接口
        self.register = handler_middle.register_member(
            self.brand, headers=self.headers, var=handler.yml_conf["var"]["vb_all_api"])
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        actual = visit(url=handler.yml_conf["host"] + handler.yml_conf["var"]["vb_all_api"] + data_info["url"],
