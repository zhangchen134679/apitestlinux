...
cases = excel.read_data("query_member_grade")
...
@pytest.mark.lrl
@ddt.ddt
class TestQueryMemberGrade(unittest.TestCase):
    ...
    @allure.step("查询当前会员等级")
    @pytest.mark.query
    @pytest.mark.query_member_grade
    @ddt.data(*cases)
    def test_query_member_grade(self, data_info):
