...
excel = handler_middle.Handler().excel_upload_order_info

cases = excel.read_data("lrl_upload_order_verifyOrder")
            ...
            for self.k, self.v in expect_response.items():
                ...
                if self.k in "data" and actual["code"] == 0:
                    for self.key, self.value in self.v.items():
                        ...
                        try:
                            if self.key in "orders" and data_info["case_id"] != 12:
