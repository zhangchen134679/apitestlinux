...
cases = excel.read_data("member_send_activity_info")
...
@pytest.mark.hr
@ddt.ddt
class TestMemberSendActivityInfo(unittest.TestCase):
    ...
    @allure.step("...")
    @pytest.mark.write
    @pytest.mark.member_send_activity_info
    @ddt.data(*cases)
    def test_member_send_activity_info(self, data_info):
