...
cases = excel.read_data("query_member_grade_calculator")


@ddt.ddt
class TestQueryMemberGradeCalculator(unittest.TestCase):
    ...
    @ddt.data(*cases)
    def test_query_member_grade_calculator(self, data_info):

        # 替换用例中的brand_code
        data_info = re.sub(r"#brand_code#", self.brand, str(data_info))
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中初始等级的union_code
        data_info = re.sub(r"#not_grade_union_code#", self.register_member["data"]["union_code"], str(data_info))
#  --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的value值
