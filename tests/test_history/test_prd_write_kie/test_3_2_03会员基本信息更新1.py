...
cases = excel.read_data("member_update1")
...
#  --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的store_code
        data_info = re.sub("#store_code#", handler_middle.Handler.
                           yml_conf["crm_store"][self.brand]["replace_deal_store_no"], str(data_info))
# --------------------------------------------------------------------------------------------------------------------
