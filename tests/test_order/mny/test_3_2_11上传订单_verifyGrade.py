...
excel = handler_middle.Handler().excel_upload_change_grade_MNY

cases = excel.read_data("mny_upload_order_verifyGrade")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_300_back_200 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_300_99_back_300 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_800_back_300 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_500_back_300 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_2_back_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_600_back_300 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
    ...
    def test_upload_order_verifyGrade(self, data_info):
        ...
        # --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&order_300_back_200&", self.order_300_back_200, str(data_info))
        data_info = re.sub(r"&test_order_300.99_back_300&", self.test_order_300_99_back_300, str(data_info))
        data_info = re.sub(r"&test_order_800_back_300&", self.test_order_800_back_300, str(data_info))
        data_info = re.sub(r"&test_order_500_back_300&", self.test_order_500_back_300, str(data_info))
        data_info = re.sub(r"&test_order_2_back_2&", self.test_order_2_back_2, str(data_info))
        data_info = re.sub(r"&test_order_600_back_300&", self.test_order_600_back_300, str(data_info))
        # --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的data数据..
