...
cases = excel.read_data("hr_upload_order_verifyGrade")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.test_order_68000_back_59000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_68000_back_65000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_68000_back_68000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_30000_back_21000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_30000_back_27000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_30000_back_30000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_9000_back_6000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_9000_back_9000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_3000_back_3000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&test_order_68000_back_59000&", self.test_order_68000_back_59000, str(data_info))
        data_info = re.sub(r"&test_order_68000_back_65000&", self.test_order_68000_back_65000, str(data_info))
        data_info = re.sub(r"&test_order_68000_back_68000&", self.test_order_68000_back_68000, str(data_info))
        data_info = re.sub(r"&test_order_30000_back_21000&", self.test_order_30000_back_21000, str(data_info))
        data_info = re.sub(r"&test_order_30000_back_27000&", self.test_order_30000_back_27000, str(data_info))
        data_info = re.sub(r"&test_order_30000_back_30000&", self.test_order_30000_back_30000, str(data_info))
        data_info = re.sub(r"&test_order_9000_back_6000&", self.test_order_9000_back_6000, str(data_info))
        data_info = re.sub(r"&test_order_9000_back_9000&", self.test_order_9000_back_9000, str(data_info))
        data_info = re.sub(r"&test_order_3000_back_3000&", self.test_order_3000_back_3000, str(data_info))
