...
excel = handler_middle.Handler().excel_upload_change_grade_VCH

cases = excel.read_data("vch_upload_order_verifyGrade")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # 从配置文件读取brand
        cls.brand = handler_middle.Handler.yml_conf["brand"]["vch"]
        ...
        cls.order_1600_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.order_2900_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_1000_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_2400_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_1400_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&order_1600_back_1&", self.order_1600_back_1, str(data_info))
        ...
        data_info = re.sub(r"&order_2900_back_1&", self.order_2900_back_1, str(data_info))
        data_info = re.sub(r"&order_1000_back_1&", self.order_1000_back_1, str(data_info))
        data_info = re.sub(r"&order_2400_back_1&", self.order_2400_back_1, str(data_info))
        data_info = re.sub(r"&order_1400_back_1&", self.order_1400_back_1, str(data_info))
        # --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的data数据..
