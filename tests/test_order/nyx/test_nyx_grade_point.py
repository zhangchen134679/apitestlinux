...
excel = handler_middle.Handler().excel_upload_change_grade_NYX

cases = excel.read_data("NYX_upload_order_verify")

brand = handler_middle.Handler.yml_conf["brand"]["nyx"]
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # 从配置文件读取brand
        cls.brand = handler_middle.Handler.yml_conf["brand"]["nyx"]
