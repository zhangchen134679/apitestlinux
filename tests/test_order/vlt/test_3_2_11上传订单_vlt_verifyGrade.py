...
excel = handler_middle.Handler().excel_upload_change_grade_VLT

cases = excel.read_data("vlt_upload_order_verifyGrad")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # 从配置文件读取brand
        cls.brand = handler_middle.Handler.yml_conf["brand"]["vlt"]
