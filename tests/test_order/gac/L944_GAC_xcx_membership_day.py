...
cases = excel.read_data("L944_GAC_xcx_Activity")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_3000_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.order_3000_back_3 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.order_1500_back_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&order_3000_back_1&", self.order_3000_back_1, str(data_info))
        ...
        data_info = re.sub(r"&order_3000_back_3&", self.order_3000_back_3, str(data_info))
        ...
        data_info = re.sub(r"&order_1500_back_2&", self.order_1500_back_2, str(data_info))
