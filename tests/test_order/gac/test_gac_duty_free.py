...
cases = excel.read_data("gac_duty_free")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_10000_back_1= f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_2000_back_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&order_10000_back_1&", self.order_10000_back_1, str(data_info))
        data_info = re.sub(r"&order_2000_back_2&", self.order_2000_back_2, str(data_info))
