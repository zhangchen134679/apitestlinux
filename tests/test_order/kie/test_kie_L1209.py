...
cases = excel.read_data("kie_upload_order_L1209")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # 调用方法注册品牌下的生日月会员
        for i in range(0, 3):
            member = handler_middle.register_member(cls.brand, birthday="1995-09-01", headers=cls.headers)
