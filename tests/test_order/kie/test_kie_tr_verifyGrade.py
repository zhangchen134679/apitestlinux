...
cases = excel.read_data("kie_tr_order")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.test_order_5000_back_5000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&test_order_5000_back_5000&", self.test_order_5000_back_5000, str(data_info))
