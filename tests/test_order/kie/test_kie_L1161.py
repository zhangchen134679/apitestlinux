...
cases = excel.read_data("kie_upload_order_L1161")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.test_order_1000_back_1000_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_1000_back_1000_3 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_1000_back_400 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_1000_back_1000_4 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_1000_back_1000_5 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_1000_back_1000_6 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_1000_back_1000_7 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&test_order_1000_back_1000_2&", self.test_order_1000_back_1000_2, str(data_info))
        data_info = re.sub(r"&test_order_1000_back_1000_3&", self.test_order_1000_back_1000_3, str(data_info))
        data_info = re.sub(r"&test_order_1000_back_400&", self.test_order_1000_back_400, str(data_info))
        data_info = re.sub(r"&test_order_1000_back_1000_4&", self.test_order_1000_back_1000_4, str(data_info))
        data_info = re.sub(r"&test_order_1000_back_1000_5&", self.test_order_1000_back_1000_5, str(data_info))
        data_info = re.sub(r"&test_order_1000_back_1000_6&", self.test_order_1000_back_1000_6, str(data_info))
        data_info = re.sub(r"&test_order_1000_back_1000_7&", self.test_order_1000_back_1000_7, str(data_info))
...
#  --------------------------------------------------------------------------------------------------------------------
        ...
        try:
            ...
            if str(data_info['case_id']) in ('39','40','73','74'):
