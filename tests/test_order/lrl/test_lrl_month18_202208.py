...
cases = excel.read_data("LRL_month_18_202208")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_100_back_40 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_b100_back_100 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_b100_back_40 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&order_100_back_40&", self.order_100_back_40, str(data_info))
        data_info = re.sub(r"&order_b100_back_100&", self.order_b100_back_100, str(data_info))
        data_info = re.sub(r"&order_b100_back_40&", self.order_b100_back_40, str(data_info))
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的data数据..
