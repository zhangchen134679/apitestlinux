...
cases = excel.read_data("LAN_duty_free")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_10_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_10_back_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_50_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_20_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.order_21000_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
    ...
    def test_upload_order_verifyGrade(self, data_info):
        ...
        # --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&order_10_back_1&", self.order_10_back_1, str(data_info))
        data_info = re.sub(r"&order_10_back_2&", self.order_10_back_2, str(data_info))
        data_info = re.sub(r"&order_50_back_1&", self.order_50_back_1, str(data_info))
        data_info = re.sub(r"&order_20_back_1&", self.order_20_back_1, str(data_info))
        ...
        data_info = re.sub(r"&order_21000_back_1&", self.order_21000_back_1, str(data_info))
        # --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的data数据..
