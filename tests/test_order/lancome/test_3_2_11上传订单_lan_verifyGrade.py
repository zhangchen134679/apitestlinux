...
cases = excel.read_data("lancome_upload_order_verifyGrad")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_25001_back_17000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_25001_back_20000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_25001_back_20001 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_25001_back_24001 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_25001_back_23001 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_25001_back_25001 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_25001_back_00001 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_8001_back_3000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_8001_back_4000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_8001_back_6000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_8001_back_8001 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.order_1600_back_1600 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
    ...
    def test_upload_order_verifyGrade(self, data_info):
        ...
        # --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&order_25001_back_17000&", self.order_25001_back_17000, str(data_info))
        data_info = re.sub(r"&order_25001_back_20000&", self.order_25001_back_20000, str(data_info))
        data_info = re.sub(r"&order_25001_back_20001&", self.order_25001_back_20001, str(data_info))
        data_info = re.sub(r"&order_25001_back_24001&", self.order_25001_back_24001, str(data_info))
        data_info = re.sub(r"&order_25001_back_23001&", self.order_25001_back_23001, str(data_info))
        data_info = re.sub(r"&order_25001_back_25001&", self.order_25001_back_25001, str(data_info))
        data_info = re.sub(r"&order_25001_back_00001&", self.order_25001_back_00001, str(data_info))
        data_info = re.sub(r"&order_8001_back_3000&", self.order_8001_back_3000, str(data_info))
        data_info = re.sub(r"&order_8001_back_4000&", self.order_8001_back_4000, str(data_info))
        data_info = re.sub(r"&order_8001_back_6000&", self.order_8001_back_6000, str(data_info))
        data_info = re.sub(r"&order_8001_back_8001&", self.order_8001_back_8001, str(data_info))
        ...
        data_info = re.sub(r"&order_1600_back_1600&", self.order_1600_back_1600, str(data_info))
