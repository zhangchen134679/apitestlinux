...
excel = handler_middle.Handler().excel_upload_change_grade_lp

cases = excel.read_data("default")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # 从配置文件读取brand
        cls.brand = handler_middle.Handler.yml_conf["brand"]["lp"]
        ...
        cls.tradeNo_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_3 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_4 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_5 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_6 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&tradeNo_1&", self.tradeNo_1, str(data_info))
        data_info = re.sub(r"&tradeNo_2&", self.tradeNo_2, str(data_info))
        data_info = re.sub(r"&tradeNo_3&", self.tradeNo_3, str(data_info))
        data_info = re.sub(r"&tradeNo_4&", self.tradeNo_4, str(data_info))
        data_info = re.sub(r"&tradeNo_5&", self.tradeNo_5, str(data_info))
        data_info = re.sub(r"&tradeNo_6&", self.tradeNo_6, str(data_info))
