...
cases = excel.read_data("CR1090_TMallBonus")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.test_order_200_back1_100 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_200_back2_100 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_500_back_100 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&test_order_200_back1_100&", self.test_order_200_back1_100, str(data_info))
        data_info = re.sub(r"&test_order_200_back2_100&", self.test_order_200_back2_100, str(data_info))
        data_info = re.sub(r"&test_order_500_back_100&", self.test_order_500_back_100, str(data_info))
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的data数据..
