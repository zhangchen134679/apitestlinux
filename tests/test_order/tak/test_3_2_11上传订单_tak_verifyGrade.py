...
excel = handler_middle.Handler().excel_upload_change_grade_TAK

cases = excel.read_data("tak_upload_order_verifyGrad")

"""用于需要调用订单信息更新接口"""
brand = handler_middle.Handler.yml_conf["brand"]["tak"]
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # 从配置文件读取brand
        cls.brand = handler_middle.Handler.yml_conf["brand"]["tak"]
