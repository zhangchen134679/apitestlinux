...
cases = excel.read_data("bio_upload_order_verifyGrade")
# cases = excel.read_data("a")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_1500_back_1000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_1_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_3500_back_2000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_1000_back_800 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"

        cls.order_1000_back_900 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.order_1_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_7000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_9000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"

        cls.tradeNo_1000 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
    def setUp(self) -> None:
...
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&order_1500_back_1000&", self.order_1500_back_1000, str(data_info))
        data_info = re.sub(r"&order_1_back_1&", self.order_1_back_1, str(data_info))
        data_info = re.sub(r"&order_3500_back_2000&", self.order_3500_back_2000, str(data_info))
        data_info = re.sub(r"&order_1000_back_800&", self.order_1000_back_800, str(data_info))
        data_info = re.sub(r"&order_1000_back_900&", self.order_1000_back_900, str(data_info))
        ...
        data_info = re.sub(r"&tradeNo_7000&", self.tradeNo_7000, str(data_info))
        data_info = re.sub(r"&tradeNo_9000&", self.tradeNo_9000, str(data_info))
        data_info = re.sub(r"&tradeNo_1000&", self.tradeNo_9000, str(data_info))
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中的data数据..
