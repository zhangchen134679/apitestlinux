...
cases = excel.read_data("cerave_CR1006")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.test_order_100_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.test_order_100_back_4 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.test_order_200_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&test_order_100_back_1&", self.test_order_100_back_1, str(data_info))
        ...
        data_info = re.sub(r"&test_order_100_back_4&", self.test_order_100_back_4, str(data_info))
        data_info = re.sub(r"&test_order_200_back_1&", self.test_order_200_back_1, str(data_info))
