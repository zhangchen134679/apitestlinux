...
excel = handler_middle.Handler().excel_upload_change_grade_MG

cases = excel.read_data("mg_upload_order_verifyGrade")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_650_back_300 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_650_back_500 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_650_back_650 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_350_back_200 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_350_back_350 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_150_back_150 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&test_order_650_back_300&", self.order_650_back_300, str(data_info))
        data_info = re.sub(r"&test_order_650_back_500&", self.order_650_back_500, str(data_info))
        data_info = re.sub(r"&test_order_650_back_650&", self.order_650_back_650, str(data_info))
        data_info = re.sub(r"&test_order_350_back_200&", self.order_350_back_200, str(data_info))
        data_info = re.sub(r"&test_order_350_back_350&", self.order_350_back_350, str(data_info))
        data_info = re.sub(r"&test_order_150_back_150&", self.order_150_back_150, str(data_info))
