...
cases = excel.read_data("YSL_L1015_TM")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_200_back_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_200_back_3 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_200_back_4 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&order_200_back_2&", self.order_200_back_2, str(data_info))
        data_info = re.sub(r"&order_200_back_3&", self.order_200_back_3, str(data_info))
        data_info = re.sub(r"&order_200_back_4&", self.order_200_back_4, str(data_info))
