...
cases = excel.read_data("YSL_duty_free")
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.order_200_back_1 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        ...
        cls.order_5000_back_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.order_20000_back_2 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
...
# --------------------------------------------------------------------------------------------------------------------
        ...
        data_info = re.sub(r"&order_200_back_1&", self.order_200_back_1, str(data_info))
        ...
        data_info = re.sub(r"&order_5000_back_2&", self.order_5000_back_2, str(data_info))
        data_info = re.sub(r"&order_20000_back_2&", self.order_20000_back_2, str(data_info))
