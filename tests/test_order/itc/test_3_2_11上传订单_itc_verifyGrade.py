...
excel = handler_middle.Handler().excel_upload_change_grade_itc
...
class TestUploadOrderVerifyGrade(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        # 从配置文件读取brand
        cls.brand = handler_middle.Handler.yml_conf["brand"]["itc"]
        ...
        cls.tradeNo_100 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_200 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"
        cls.tradeNo_1100 = f"{cls.test_order_back}{handler_middle.Handler().random_num}"


    #  cls.order_1_back_1 = “{}{}” .format(cls.test_order_back}{handler_middle.Handler().random_num)
    def setUp(self) -> None:
...
# --------------------------------------------------------------------------------------------------------------------
        # 替换用例中降级用到的tradeNo
        data_info = re.sub(r"&tradeNo_100&", self.tradeNo_100, str(data_info))
        data_info = re.sub(r"&tradeNo_200&", self.tradeNo_200, str(data_info))
        data_info = re.sub(r"&tradeNo_1100&", self.tradeNo_1100, str(data_info))
